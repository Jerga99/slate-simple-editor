...
var BlogEditor = function BlogEditor(_ref5) {
  ...
  var save = function save() {
    ...
    var title = value[0].children.map(function (n) {
      return n.text;
    }).join('');
    var subTitle = value[1].children.map(function (n) {
      return n.text;
    }).join('');
    onSave({
      content: serialized,
  ...
  }, "Save")), loading && /*#__PURE__*/React.createElement("span", {
    className: "ml-3"
  }, "saving...")), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement(Slate, {
    editor: editor,
    value: value,
